 ...
 */
export const Receipt: React.FC<ReceiptProps> = ({ patient, receiptData, consultant, logoUrl, hospitalName, address, language = 'en', className, printOptions, showSignSeal = false }) => {
