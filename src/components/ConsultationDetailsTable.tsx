              ...
              {selectedConsultation.consultation_data && (
                <ConsultationCard 
                  data={{ 
                    ...
                    radiology_images: (selectedConsultation.radiology_images && selectedConsultation.radiology_images.length > 0) ? selectedConsultation.radiology_images : selectedConsultation.consultation_data?.radiology_images,
