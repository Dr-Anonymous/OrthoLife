                                                    ...
                                                    <div>
                                                        <div className="flex flex-wrap gap-4 mb-6">
                                                            {doctor.socials.facebook && (
                                                                <a href={doctor.socials.facebook} target="_blank" className="text-gray-500 hover:text-[#1877F2] transition-colors">
                                                                    <Facebook className="w-6 h-6" />
                                                                </a>
                                                            )}
                                                            {doctor.socials.whatsapp && (
                                                                <a href={doctor.socials.whatsapp} target="_blank" className="text-gray-500 hover:text-[#25D366] transition-colors">
                                                            ...
                                                            {doctor.socials.instagram && (
                                                                <a href={doctor.socials.instagram} target="_blank" className="text-gray-500 hover:text-[#E4405F] transition-colors">
                                                            ...
                                                            {doctor.socials.google && (
                                                                <a href={doctor.socials.google} target="_blank" className="text-gray-500 hover:text-blue-500 transition-colors">
