          ...
          <div className="w-full md:w-1/2 mb-10 md:mb-0">
            <div className="max-w-xl space-y-6 animate-fade-in" style={{animationDelay: '0.1s'}}>
              ...
              <p className="text-lg text-gray-700">
                OrthoLife offers expert care for all conditions from fractures and sports injuries to spine, joint, and orthobiologic treatments. Get back to doing what you love—stronger, faster, pain-free.
              </p>
