        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/drsamuelcherukuri" className="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary transition-colors">
