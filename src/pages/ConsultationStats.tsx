...
const ConsultationStats = () => {
  ...
  const [dailyData, setDailyData] = useState<DailyConsultation[]>([]);
      ...
      <div className="container mx-auto max-w-4xl">
        <Card className="shadow-lg border-0 bg-card/95 backdrop-blur">
          ...
          <CardContent className="space-y-8">
                  ...
                  <>
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Total consultations for {selectedDate ? format(selectedDate, 'MMMM yyyy') : 'the selected month'}.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                    ...
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Consultations for {selectedDate ? format(selectedDate, 'PPP') : 'the selected day'}.
                        </CardDescription>
                      </CardHeader>
                      <CardContent>
                        <p className="text-4xl font-bold">{dailyData.length}</p>
                        {dailyData.length > 0 && (
                          <Button variant="link" onClick={() => setShowDetails(!showDetails)} className="px-0">
            ...
            {showDetails && dailyData.length > 0 && (
              <div className="mt-8">
                <h3 className="text-xl font-semibold mb-4">Details for {selectedDate ? format(selectedDate, 'PPP') : ''}</h3>
