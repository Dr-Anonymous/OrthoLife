...
export const DISCHARGE_INSTRUCTIONS = {
    en: {
        red_flags: `When to Contact Doctor Immediately:
- Excessive Pain: Pain not relieved by the prescribed medication.
- Swelling/Tightness: Increased swelling or fingers feeling very tight/numb.
- Fever: Temperature above 100°F.
- Wound Issues: Foul smell, active bleeding, or pus from the dressing.
...
- Sling Usage: Wear the arm sling at all times, including while sleeping, unless told otherwise.
- Walker: Use a walker for support while walking.
- Knee Bending: Do knee bending exercises as demonstrated.
...
- పాదాలను పైకి కిందకి ఆడిస్తూ (Ankle Pumps) ఉండాలి.`
    }
};

export const DAMA_TEXT = {
    en: "The risks of leaving against medical advice, including infection, non-union, and permanent loss of function, have been explained to the patient and attendants in their local language.",
    te: "వైద్య సలహాకు విరుద్ధంగా ఆసుపత్రి నుండి వెళ్ళడం వల్ల కలిగే ప్రమాదాలు (ఇన్ఫెక్షన్, ఎముక అతుక్కోకపోవడం, శాశ్వత వైకల్యం మొదలైనవి) రోగికి మరియు వారి బంధువులకు వారికి అర్థమయ్యే భాషలో వివరించబడ్డాయి."
};
